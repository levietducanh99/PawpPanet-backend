...
CREATE TABLE IF NOT EXISTS "auth"."follow_user" (
                                      "follower_id" bigint,
                                      "following_id" bigint,
                                      "created_at" timestamp,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."classes" (
                                          "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."species" (
                                          "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                          "class_id" bigint,
                                          "name" varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."species_attributes" (
                                                     "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                     "species_id" bigint,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."species_sections" (
                                                   "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."species_section_contents" (
                                                           "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                           "species_id" bigint,
                                                           "section_id" bigint,
                                                           "language" varchar,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."breeds" (
                                         "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                         "species_id" bigint,
                                         "name" varchar NOT NULL,
                                         "origin" varchar,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."breed_attributes" (
                                                   "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                   "breed_id" bigint,
                                                   "key" varchar NOT NULL,
                                                   "value" varchar,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."breed_sections" (
                                                 "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                 "code" varchar UNIQUE NOT NULL,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."breed_section_mapping" (
                                                        "breed_id" bigint,
                                                        "section_id" bigint,
                                                        "display_order" int,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."breed_section_contents" (
                                                         "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                                         "breed_id" bigint,
                                                         "section_id" bigint,
                                                         "language" varchar,
...
CREATE TABLE IF NOT EXISTS "encyclopedia"."media" (
                                        "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                        "entity_type" varchar,
                                        "entity_id" bigint,
                                        "type" varchar,
...
CREATE TABLE IF NOT EXISTS "pet"."pet_adoption_profiles" (
...
CREATE TABLE IF NOT EXISTS "pet"."pet_media" (
                                   "id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                                   "pet_id" bigint,
                                   "type" varchar,
                                   "role" varchar,
...
CREATE TABLE IF NOT EXISTS "pet"."follow_pet" (
                                    "user_id" bigint,
                                    "pet_id" bigint,
                                    "created_at" timestamp,
